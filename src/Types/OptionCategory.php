...
class OptionCategory extends XMLConvertable
{
	...
	public function __construct(\SimpleXMLElement $XMLElement, bool $describeProperties)
	{
		...
		$converter->convertIntProperties('Id','BrandId');
		$converter->convertStringProperties('Reference');

		// Circumvent typo bug
		if (isset($XMLElement->Translation)) $converter->convertStringProperties('Translation');
		else if (isset($XMLElement->Transation)) $converter->convertStringProperties('Transation');
	}
